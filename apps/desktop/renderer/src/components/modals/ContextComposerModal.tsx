  ...
  return (
      ...
      footer={
        <div className="flex w-full items-center justify-between gap-4">
          <p className="hidden text-xs leading-5 text-neutral-600 md:block">
            {selectedFiles.length} of {fileCandidates.length} file candidate(s)
    ...
    >
      <div className="flex h-[calc(100vh-190px)] min-h-[560px] flex-col overflow-hidden p-5">
        <div className="mb-4 grid shrink-0 gap-4 xl:grid-cols-[minmax(0,1fr)_430px]">
          <section className="rounded-[1.5rem] border border-neutral-900 bg-black/40 p-5">
            ...
            <p className="mt-3 line-clamp-2 max-w-4xl text-sm leading-6 text-neutral-500">
              Include the files you want to send into final Task Pack generation.
              Add extra files only when the initial context misses something important.
            </p>
          </section>
        ...
        <div className="grid min-h-0 flex-1 gap-4 xl:grid-cols-[410px_minmax(0,1fr)]">
          <aside className="flex min-h-0 flex-col overflow-hidden rounded-[1.5rem] border border-neutral-900 bg-black/35 p-4">
