            ...
            <header className="app-drag relative z-50 flex h-12 shrink-0 items-center justify-between border-b border-white/[0.075] bg-black/88 px-3 shadow-[0_1px_0_rgba(255,255,255,0.025)] backdrop-blur-xl">
                <div className="flex min-w-0 items-center gap-3">
                    ...
                    <div className="flex min-w-0 items-center gap-2">
                        <p className="cf-brand-font truncate text-lg font-semibold text-white">
                            {appMeta.name}
                        </p>
                ...
                <div className="app-no-drag flex items-center gap-2">
                    {onAddProject && (
                        <button
                            ...
                            disabled={isLoading}
                            className="cf-pressable mr-2 hidden h-8 items-center gap-2 rounded-full bg-white px-3.5 text-xs font-medium text-black shadow-[0_12px_30px_rgba(0,0,0,0.42)] transition hover:bg-neutral-200 disabled:cursor-not-allowed disabled:opacity-60 md:inline-flex"
                        >
                            <FolderOpen size={14} />
