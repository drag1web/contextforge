  ...
  ru: {
    translation: {
      ...
      selectorDiagnostics: {
        ...
        modes: {
          ...
          shadow_compare: {
            label: "Сравнение",
            description:
              "Пакет задачи создаёт Legacy, а Shadow параллельно формирует локальную диагностику сравнения.",
          },
          shadow_primary: {
            label: "Shadow",
            description:
              "Новое детерминированное ядро создаёт пакет задачи; при техническом сбое выполняется откат на Legacy.",
          },
        },
      },
      taskPackExport: {
      ...
      settings: {
        ...
        selectorRolloutDescription:
          "Выберите, какой selector формирует пакет задачи. Режимы сравнения и Shadow предназначены для внутреннего тестирования.",
        ...
        recommendedSetupDesc:
          "Для ежедневной работы держите описания скрытыми. Свёрнутый режим даёт больше места таблицам, Composer и пакетам задач.",
        ...
        generationDescription:
          "Выберите режим генерации, AI-инструмент по умолчанию, тип задачи и локальную модель для новых пакетов задач.",
        ...
        ollamaMode: "Ollama-assisted mode",
        ollamaModeDesc: "Использует локальные модели для улучшения пакетов задач.",
