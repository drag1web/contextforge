  ...
  ru: {
    translation: {
      ...
      taskPacksPage: {
        ...
        libraryTitle: "Task Packs",
        libraryDescription:
          "Спокойная библиотека сохранённых промптов, экспорта, передачи на сайт и повторного использования.",
        ...
        websiteUnavailableDescription:
          "ContextForge Web сейчас недоступен. Локальные Task Packs продолжают работать.",
        cloudRequestFailedFriendly:
          "Запрос к сайту не выполнен. Локальные Task Packs не затронуты.",
        incomingCount: "Входящих Task Packs: {{count}}",
        ...
        publishStepOneDescription: "Нажмите ••• у Task Pack, который хотите передать на сайт.",
        publishStepTwoTitle: "Опубликуйте выбранный пакет",
        publishStepTwoDescription: "Выберите «Опубликовать на сайте». Передаётся только этот Task Pack.",
